...
import 'package:app/widget/chat_message.dart';
...
class _ChatViewState extends State<ChatView> {
  ...
  Widget build(BuildContext context) {
    ...
    final receiver = ModalRoute.of(context)!.settings.arguments as MAkun;

    Future<void> trySend() async {
      if (chatController.text.isNotEmpty) {
        await consultationController.kirimPesan(chatController.text);
      }
      scrollDown();
    }
